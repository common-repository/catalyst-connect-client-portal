...
<form role="form" action="" method="post" id="layout_View>">
    ...
    <?php if($subformFld !=""){ ?>
        <button type="button" class="btn btn-primary addRowSubform" style="color: #fff;float: right;   "><i class="fas fa-plus"></i> Add Subform Section</button>
    <?php } ?>

    <button type="button" class="btn btn-primary addRow" style="color: #fff;float: right; margin-right: 10px;"><i class="fas fa-plus"></i> Add Section</button>
...
<div class="row layoutRow">
    ...
    <div class="layoutColumnContainer">
        ...
        for ($i=0; $i < $layViewV['columnAdded'][$rowP]; $i++) {
            ...
            if(isset($layViewV['fldAdd'][$fldP]))$fldAdd = $layViewV['fldAdd'][$fldP];
            ...
            if(isset($layViewV['subformfieldName_'.$fieldApiName])) {
                $isSubfrom = true;
                $subfSlct = "width: calc(100% - 165px) !important;";
            }
    ...
    <div class="layoutColumn col-md-<?php echo $exlyFldClm; ?>" <?php if($isSubfrom){ ?>style="width: calc(100% - 150px) !important;"<?php } ?>>
        ...
        <select class="form-control update_fieldNameValue <?php if($isSubfrom)echo 'subfromSelect'; ?>" name="fieldName[]" required>
            <option value="">--Select One--</option>
            <option selected value="<?php echo $exfldN ?>"><?php echo str_replace("_", " ", $fieldDValue) ?></option>
            <?php 
            if($exfldN != "Search_Address"){
                if($isSubfrom){
        ...
        <div class="fieldAcp" style="<?php if($exfldN == "Search_Address")echo 'display: none'; ?>">
    ...
    <?php  
    if($isSubfrom){
        $SubfromCRMFields = $CrmModules->getSubformFieldList($module.'__'.$fieldApiName);
