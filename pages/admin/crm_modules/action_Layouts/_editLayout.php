<?php
    ...
    $crmMdl = $wpdb->get_row("SELECT * FROM ccgclientportal_options WHERE option_name = 'crmModules' AND option_index LIKE 'lay_Edit_$acTab'");
    if(isset($crmMdl->option_index))$layViewV = json_decode($crmMdl->option_value, true); 
?>

<div class="tab-pane fade active in" id="apTab_Edit">

    <form role="form" action="" method="post" id="layout_Edit">   
...
<div class="row layoutRow">
    <div class="layoutRowHeader col-md-12">
        ...
        <input type="text" class="form-control sectiontitle" title="Section Title" name="sectiontitle[]" value="<?php echo (isset($layViewV['sectiontitle'][$rowP])) ? $layViewV['sectiontitle'][$rowP] : ""; ?>">
            ...
            <div class="layoutColumn col-md-<?php echo $exlyFldClm; ?>">
                ...
                <select class="form-control update_fieldNameValue <?php if($isSubfrom)echo 'subfromSelect'; ?>" style="<?php echo $subfSlct; ?>" name="fieldName[]" required>
                    ...
                    if($isSubfrom){
                        ...
                        echo str_replace($selectedField, "", $editAbleFld);
                    }
                        // echo $viewAbleFld;
                    ?>
                </select>
